...
export const decreaseProductQuantity = (productId, messagePopupRef, quantity = 1) => async (dispatch) => {
...
export const increaseProductQuantity = (productId, messagePopupRef, quantity = 1) => async (dispatch) => {
...
export const setProductQuantity = (productId, quantity = 1) => async (dispatch) => {
