...
const getLocationAsync = () => new Promise((resolve, reject) => {
...
export const setRegionByPlace = (placeId, cb) => async (dispatch) => {
...
export const setCurrentRegion = (cb) => async (dispatch) => {
